# Contributing to MultiNEAs

We welcome contributions to MultiNEAs! This document provides guidelines for contributing to the project.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/MultiNEAs.git
   cd MultiNEAs
   ```
