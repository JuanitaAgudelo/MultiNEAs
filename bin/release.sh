...
INIT_PY="$ROOT_DIR/src/multineas/__init__.py"
VERSION_PY="$ROOT_DIR/src/multineas/version.py"
...
log "Releasing MultiNEAs $VERSION_NEW (current: $CURRENT_SETUP) in '$TYPE' mode..."

BACKUP_DIR="$(mktemp -d -t multineas-release.XXXXXX)"
