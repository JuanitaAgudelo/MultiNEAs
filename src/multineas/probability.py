...
class OrbitElementsPDF:
    ...
    def __init__(
        self, fit_cmnd: FitCMND, scales: Union[List[float], np.ndarray] = None
    ):
        """
...
def compute_jacobian_qei_to_QEI(
    q: float, e: float, i: float, q_max: float, e_max: float, i_max: float
) -> np.ndarray:
    """
...
def integrate(
    ...
    widths: Union[Tuple, List, np.ndarray],
    max_elements: Union[Tuple, List],
    pdf: PhaseSpacePDF,
    n_points: int = 8,
) -> float:
    """
...
def marginalize(
    center: Union[Tuple, List, np.ndarray],
    widths: Union[Tuple, List, np.ndarray],
    fixed_values: Union[Tuple, List, np.ndarray],
    max_elements: Union[Tuple, List],
    pdf: PhaseSpacePDF,
    integrate_over: str = "velocity",
    n_points: int = 8,
) -> float:
    """
